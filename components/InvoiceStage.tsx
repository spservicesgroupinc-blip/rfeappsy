...
export const InvoiceStage: React.FC<InvoiceStageProps> = ({
    ...
    const { saveEstimate, generateAndUploadPDF } = useEstimates();
    ...
    const handleMarkPaidClick = async () => {
        if (confirm("Confirm payment receipt? This will finalize the invoice.")) {
            ...
            try {
                ...
                // Note: generateAndUploadPDF('RECEIPT') is handled inside handleMarkPaid in useEstimates!
    ...
    const handleUpdateClick = async () => {
        ...
        if (updatedRecord) {
            // Upload PDF
            await generateAndUploadPDF(updatedRecord, 'INVOICE');
